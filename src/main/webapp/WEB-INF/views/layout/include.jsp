...
<!-- ===================== 기타 CSS  ======================  -->
 <!-- Custom fonts for this template -->
    ...
    <link href="${pageContext.request.contextPath}/static/css/grid.css" rel="stylesheet">
     <link href="${pageContext.request.contextPath}/static/css/easisoft.css" rel="stylesheet">
...
<!-- ===================== 자바스크립트 불러오기  ======================  -->
 <!-- Bootstrap core JavaScript-->
    ...
    <script src="${pageContext.request.contextPath}/static/js/grid.js"></script>
    <!-- Page level plugins -->
