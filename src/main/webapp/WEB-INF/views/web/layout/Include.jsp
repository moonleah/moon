...
<%@ taglib uri="http://www.springframework.org/tags" prefix="spring" %>
    ...
    <!-- Favicon -->
    <link href="${pageContext.request.contextPath}/web/img/favicon.ico" rel="icon">
    ...
    <link href="${pageContext.request.contextPath}/web/lib/animate/animate.min.css" rel="stylesheet">
    ...
    <script src="${pageContext.request.contextPath}/web/lib/wow/wow.min.js"></script>
