...
<script src="${pageContext.request.contextPath}/web/js/jquery-1.11.1.min.js"></script>
<!--webfonts-->
...
<!-- banner -->
	<div class="banner">
		<div class="header">
			<div class="container">
				<div class="logo">
					<h1><a href="index.html">Private Room</a></h1>
				</div>
				...
				<!-- search-scripts -->
					<script src="${pageContext.request.contextPath}/web/js/classie.js"></script>
					<script src="${pageContext.request.contextPath}/web/js/uisearch.js"></script>
					<script>
...
<!-- footer -->
	...
	<div class="footer-bottom">
			<div class="container">
				<p>Â© 2015 Motel. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
			</div>
		</div>
	<!-- footer -->
</body>
